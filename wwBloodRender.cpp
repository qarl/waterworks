...
void wwBloodRender::build_height_table()
{
  int i;
...
void wwBloodRender::build_thickness_table()
{
  int i;
  for (i = 0; i < HEIGHT_RES; i++)
    {
...
void wwBloodRender::build_fresnel_table()
{
  int i;
  float slope;
...
void wwBloodRender::build_specular_table()
{
  int i;
  float slope;
...
void wwBloodRender::build_refract_table()
{
  int i;
  float slope;
...
void wwBloodRender::build_color_table()
{
  int i;
...
void wwBloodRender::make_height_blur(const wwMapValue &water)
{
  int x, y, a;
...
void wwBloodRender::draw(const wwMapColor &image, const wwMapValue &water,
			 wwMapColor &output)
{
  int x, y, c;
...
void wwBloodRender::doIt(const wwMapColor &image, const wwMapValue &water,
			 wwMapColor &output)
{
